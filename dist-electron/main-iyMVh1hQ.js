...
const mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-ClEFHAxh.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
const asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-D-BfcDFc.js")).AsfParser(metadata, tokenizer, options);
  }
};
const dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-BKDkaqQw.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
const aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-DwfbMvw3.js")).AIFFParser(metadata, tokenizer, options);
  }
};
const dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-B3M30_f8.js")).DsfParser(metadata, tokenizer, options);
  }
};
const flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-CoWbB3Wg.js")).FlacParser(metadata, tokenizer, options);
  }
};
const matroskaParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MatroskaParser-DR24CuZY.js")).MatroskaParser(metadata, tokenizer, options);
  }
};
const mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-B-dxuTeC.js")).MP4Parser(metadata, tokenizer, options);
  }
};
const musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-naKVDhnf.js")).MusepackParser(metadata, tokenizer, options);
  }
};
const oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-D33vYhUG.js")).OggParser(metadata, tokenizer, options);
  }
};
const wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-Dgd2uqWE.js")).WavPackParser(metadata, tokenizer, options);
  }
};
const riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-DIokw6RN.js")).WaveParser(metadata, tokenizer, options);
  }
};
  ...
  if (!gotTheLock) {
    ...
    app.on("second-instance", (_, argv) => {
      const filePath = argv.find(
        (arg) => path$1.extname(arg).toLowerCase() === ".mp3"
      );
      if (filePath) {
