...
const mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-D7g7sLRl.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
const asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-Bfc-HKf0.js")).AsfParser(metadata, tokenizer, options);
  }
};
const dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-Dyp9T7pN.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
const aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-SkzbBPfc.js")).AIFFParser(metadata, tokenizer, options);
  }
};
const dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-TDtQqRyC.js")).DsfParser(metadata, tokenizer, options);
  }
};
const flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-BVWuKZqR.js")).FlacParser(metadata, tokenizer, options);
  }
};
const matroskaParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MatroskaParser-BEnRASCg.js")).MatroskaParser(metadata, tokenizer, options);
  }
};
const mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-BS7cxhCP.js")).MP4Parser(metadata, tokenizer, options);
  }
};
const musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-BmZ3hIbk.js")).MusepackParser(metadata, tokenizer, options);
  }
};
const oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-4Mf6T-x-.js")).OggParser(metadata, tokenizer, options);
  }
};
const wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-CdxefDxd.js")).WavPackParser(metadata, tokenizer, options);
  }
};
const riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-CIiLLmPp.js")).WaveParser(metadata, tokenizer, options);
  }
};
...
async function readAudioFile(filePath) {
  ...
  try {
    ...
    const coverMimeType = cover == null ? void 0 : cover.format;
    return {
      base64,
      name,
      artist,
